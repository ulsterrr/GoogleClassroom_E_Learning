...
<body>
    ...
    <section class="dashboard container">
        <div class="dashboard__header">
            <img src="{{ asset('images/' . auth()->user()->hinhdaidien) }}" alt="Avatar" class="dashboard__avatar" />
        ...
        <div class="dashboard__info">
            ...
            <a class="dashboard__submit btn btn-primary text-white" href="{{ route('cap-nhat-tai-khoan') }}"
