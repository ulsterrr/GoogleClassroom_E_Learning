...
<body>
    ...
    <header
      ...
      ">
        ...
        <nav class="d-flex align-items-center gap-3">
            ...
            <a class="d-flex align-items-center text-secondary" href="#">Bài tập</a>
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <div class="avatar me-3">
                        <img src="{{ asset('images/' . $lophoc->TaiKhoan->hinhdaidien) }}" alt="Avatar" />
                    </div>
                ...
                @if ($hocvien->trangthai == 1)
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="avatar me-3">
                                <img src="{{ asset('images/' . $hocvien->TaiKhoan->hinhdaidien) }}" alt="Avatar" />
                            </div>
    ...
    <section class="container mt-4 border py-4 bg-white" style="padding-top: 15px;">
        ...
        <form class="d-flex gap-2 mb-4 border-bottom pb-3" action="{{ route('AddMail', ['id' => $lophoc->id]) }}"
            method="post">
            @csrf
            <div class="flex-grow-1">
                <input type="email" class="form-control py-2" placeholder="Nhập Email của học viên" name="addmail" />
            </div>
            ...
            @foreach ($dsHocvien as $hocvien)
                @if ($hocvien->trangthai == 0)
                    <li class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            <div class="avatar me-3">
                                <img src="https://avatars.dicebear.com/api/adventurer-neutral/123456.svg"
                                    alt="Avatar" />
                            </div>
                            <span class="fs-5">{{ $hocvien->TaiKhoan->hoten }}</span>
                        </div>
                        <div>
                            <a
                                href="{{ route('confirmstudent', ['idtaikhoan' => $hocvien->taikhoanid, 'idlop' => $hocvien->lophocid]) }}">
                                <div class="d-inline-flex btn btn-primary me-2">Accept Request</div>
                            </a>

                            <a
                                href="{{ route('deletestudent', ['idtaikhoan' => $hocvien->taikhoanid, 'idlop' => $hocvien->lophocid]) }}">
