...
<body>
    ...
    <section class="px-4 p mb-4">
        <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#modal-student">
            <i class="fa fa-plus"></i>
        </button>

        <div class="modal fade" id="modal-student" tabindex="-1" style="display: none" aria-hidden="true">
