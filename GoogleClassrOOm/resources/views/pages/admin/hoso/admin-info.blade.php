        ...
        <div class="row">
            @if (session('message.profile'))
                <div class="alert alert-success alert-block">
                    ...
                    <p>Bạn có thể xem thay đổi trong "Chi tiết hồ sơ"</p>
                </div>
            @endif
        </div>
        <!-- End of Success And Fail/Error Alert -->
                            ...
                            <div class="card-body box-profile">
                                <div class="text-center">
                                    @if (auth()->user()->hinhdaidien)
                                        <img src="{{ asset('images/' . auth()->user()->hinhdaidien) }}"
                                            alt="Ảnh đại diện">
                                    @else
                                        <img src="{{ asset('images/' . auth()->user()->hinhdaidien) }}"
                                            alt="Ảnh đại diện">
                            ...
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="#activity"
                                            data-toggle="tab">Chi tiết hồ sơ</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#settings"
                                            data-toggle="tab">Thay đổi thông tin</a></li>
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="#avt"
                                            data-toggle="tab">Thay đổi hình đại diện</a></li>
                                </ul>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input name="name" type="name" class="form-control"
                                                        placeholder="Họ tên" value="{{ auth()->user()->hoten }}">
                                                    @if ($errors->has('name'))
                                    ...
                                    <div class="tab-pane" id="password">
                                        ...
                                        <form class="form-horizontal" method="post"
                                            action="{{ route('add-doi-mk') }}">
                                            @csrf
                                            {{ method_field('POST') }}
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 col-form-label">Mật khẩu hiện
                                                    tại</label>
                                                <div class="col-sm-10">
                                    ...
                                    <div class="tab-pane" id="avt">
                                        ...
                                        <form class="form-horizontal" method="post"
                                            action="{{ route('add-doi-avt') }}" enctype="multipart/form-data">
                                            @csrf
                                            {{ method_field('POST') }}
                                            <div class="col-md-12">
                                                <div class="card card-primary">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <label>Ảnh đại diện của {{ auth()->user()->hoten }}</label>
