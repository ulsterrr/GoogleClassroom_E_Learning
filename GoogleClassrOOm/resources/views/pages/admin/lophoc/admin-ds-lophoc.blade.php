                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header center">
                            <h4 class="center" style="justify-content: center;text-align: center;">Thêm lớp học
                            </h4>
                        </div>
                        ...
                        <form class="add-class center" action="{{ route('add-tao-lop') }}" method="post">
                            ...
                            <div class="mx-3 my-3">
                                ...
                                <div class="mb-3">
                                    <label class="">Chọn giảng viên</label>
                                    <div class="col-sm-10">
                                ...
                                <tbody>
                                    @foreach ($lophoc as $k)
                                        <tr>
                                            <td>{{ $k->tenlop }}</td>
                                            <td>{{ $k->chude }}</td>
                                            <td>{{ $k->TaiKhoan->hoten }}</td>
                                            <td>
                                                <a type="button" class="btn btn-block bg-gradient-primary btn-xs"
                                                    href="{{ route('ad-sua-lop', ['id' => $k->id]) }}">Sửa</a>
                                                <a type="button" class="btn btn-block bg-gradient-danger btn-xs"
                                                    onclick="return confirm('Bạn có chắc xóa lớp {{ $k->tenlop }}?')"
                                                    href="{{ route('ad-xoa-lop', ['id' => $k->id]) }}"
                                                    class="delete"
                                                    data-confirm="Bạn có chắc muốn xóa lớp này?">Xóa</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
