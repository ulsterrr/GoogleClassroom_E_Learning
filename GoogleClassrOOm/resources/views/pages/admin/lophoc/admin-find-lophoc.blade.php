                    ...
                    <tbody>
                      @foreach($search as $s )
                        <tr>
                            ...
                            <td>{{ $s->deskripsi }}</td>
                            <td>
                                <a type="button" class="btn btn-block bg-gradient-primary btn-xs" href="/Okemin/Kelas/Edit/{{ $s->id }}">Edit</a>
                                <a type="button" class="btn btn-block bg-gradient-danger btn-xs" href="/Okemin/Kelas/Delete/{{ $s->id }}">Delete</a>
                            </td>
                        </tr>
                      @endforeach
                    </tbody>
