            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form role="form" action="{{ route('add-sua-lop', ['id' => $lophoc->id]) }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label for="input1" class="col-sm-2 col-form-label">Tên Lớp Học</label>
                                <div class="col-sm-10">
                                    <input value="{{ $lophoc->tenlop }}" name="tenlop" type="name"
                                        class="form-control" id="input1" placeholder="Tên Lớp Học">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input value="{{ $lophoc->chude }}" name="chude" type="text"
                                        class="form-control" id="input2" placeholder="Chủ đề">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="input2" class="col-sm-2 col-form-label">Giảng viên</label>
                                <div class="col-sm-10">
                                    <select name="giangvien" class="form-control">
                                        @foreach ($gv as $g)
                                            <option value="{{ $g->maloaitk }}">{{ $g->hoten }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <button name="submit" type="submit" class="btn btn-block bg-gradient-primary">Xác
                                nhận</button>
                        </form>
