    ...
    <section class="content">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <form role="form" action="/Okemin/User/Teacher/Profile/Picture/Send/{{ $gv->id }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label>Ảnh của {{$gv->hoten}}</label>
                        <br>
                        <input name="avatar" type="file" id="exampleInputFile">
                    </div>
                    <div class="callout callout-warning">
                        <p>Chọn ảnh đúng định dạng. Kích cỡ tệp ảnh không lớn hơn 2MB.</p>
                    </div>                   
                    <button name="submit" type="submit" class="btn btn-block bg-gradient-primary">Đăng ảnh</button>
                </form>
