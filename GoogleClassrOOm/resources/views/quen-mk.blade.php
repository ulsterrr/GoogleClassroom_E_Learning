...
<body>
    ...
    <div class="mt-5 col-10 col-md-7 col-lg-3 text-center mx-auto">
        ...
        <form action="{{ route('quenMatKhau') }}" method="post">
            @csrf
            <div class="mb-3">
                <input class="form-control py-3" placeholder="Tài Khoản" name="tai_khoan" />
            </div>
            <!-- <div class="mb-3">
          <input
            type="password"
          ...
          />
            ...
            <div class="mb-3">
                <input type="text" class="form-control py-3" placeholder="SĐT hoặc Email" name="Phone" />
            </div>
            <div class="mb-3">
                <input type="password" class="form-control py-3" placeholder="Mật khẩu mới" name="newpass" />
            </div>
            <!-- <div class="mb-3">
          <input
            type="password"
